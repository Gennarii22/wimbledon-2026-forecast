        ...
        text=dict(
            it=dict(
                ...
                method=[
                    ...
                    "Aggiustamento per la forma recente sull'erba (warm-up): tenuto solo perche' migliora il backtest out-of-sample, utile soprattutto nel tabellone femminile.",
            ...
            en=dict(
                ...
                method=[
                    ...
                    "Recent grass form (warm-up) adjustment, kept only because it improves the out-of-sample backtest, most useful on the women's draw.",
